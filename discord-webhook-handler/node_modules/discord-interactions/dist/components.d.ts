...
export type MessageComponent = ActionRow | Button | StringSelect | UserSelect | RoleSelect | MentionableSelect | ChannelSelect | InputText | Section | TextDisplay | Thumbnail | MediaGallery | FileComponent | Separator | Container;
...
export type ActionRow = BaseComponent & {
    ...
    components: Array<Button | StringSelect | UserSelect | RoleSelect | MentionableSelect | ChannelSelect | InputText>;
};
 ...
 */
export type MentionableSelect = SelectMenu<MessageComponentTypes.MENTIONABLE_SELECT>;
/**
...
export declare enum SeparatorSpacingTypes {
    SMALL = 1,
    LARGE = 2
}
/**
